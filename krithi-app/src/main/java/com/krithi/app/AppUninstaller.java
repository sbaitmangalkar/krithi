...
/**
 * Uninstaller for the KRITHI app.
 * 
...
public class AppUninstaller{
	...
	public void buildUninstaller() {
		...
		mainUninstallerFrame = new JFrame("K.R.I.T.H.I v1.0");
		...
		JLabel uninstallMsgLabel = new JLabel("Are you sure you want to uninstall KRITHI from your system?");
